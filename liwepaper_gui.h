...
HWND CrWin(LPCWSTR, LPCWSTR, HINSTANCE);
HWND CrEdit(HWND, LPCWSTR, UINT, UINT, UINT, UINT, UINT_PTR);
HWND CrButton(HWND, LPCWSTR, UINT, UINT, UINT, UINT, UINT_PTR);
HWND CrStatic(HWND, LPCWSTR, UINT, UINT, UINT, UINT);
HWND CrLine(HWND, UINT, UINT, UINT, UINT);
HWND CrCheck(HWND, LPCWSTR, UINT, UINT, UINT, UINT, UINT_PTR, int);
NOTIFYICONDATA CrNotifyIcon(HWND, LPCWSTR);
HMENU CrPopupMenu();
void changeStaticColor(HDC);
void drawControls(HWND, HFONT, int);
